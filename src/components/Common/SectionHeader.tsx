  ...
  return (
    <>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="animate_top mx-auto text-center mb-10"
      >
        <div className="mb-4 inline-block rounded-full bg-zumthor px-5 py-1.5 border border-dark dark:border dark:border-white dark:bg-blacksection">
